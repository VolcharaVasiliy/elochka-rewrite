...
internal sealed class PaddleOcrTextService : ITextRecognitionService, IDisposable
{
    ...
    private const string PaddleHomeEnvVar = "BEREZKA_PADDLE_HOME";
    private const string LegacyPaddleHomeEnvVar = "ELOCHKA_PADDLE_HOME";
    private const string PaddlexCacheHomeEnvVar = "BEREZKA_PADDLEX_CACHE_HOME";
    private const string LegacyPaddlexCacheHomeEnvVar = "ELOCHKA_PADDLEX_CACHE_HOME";
    ...
    {
        _cacheDirectory = BerezkaPaths.OcrCacheDirectory;
    }
    ...
    private static string ResolvePaddleHomePath()
    {
        var candidates = new[]
        {
            ...
            Environment.GetEnvironmentVariable(LegacyPaddleHomeEnvVar),
            BerezkaPaths.PaddleHomeDirectory,
        };
    ...
    private static string ResolvePaddlexCacheHomePath()
    {
        var candidates = new[]
        {
            ...
            Environment.GetEnvironmentVariable(LegacyPaddlexCacheHomeEnvVar),
            BerezkaPaths.ResolvePaddlexCacheHome(),
        };
