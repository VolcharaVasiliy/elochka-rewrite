...
using Berezka.App.Forms;
using Berezka.App.Interop;
using Berezka.App.Models;
using Berezka.App.Services;
using Berezka.App.Services.Translation;

namespace Berezka.App.Application;

internal sealed class BerezkaApplicationContext : ApplicationContext
{
    ...
    public BerezkaApplicationContext()
    {
        BerezkaPaths.MigrateLegacySettingsIfNeeded();
        _settingsStore = new SettingsStore(BerezkaPaths.SettingsFilePath);
